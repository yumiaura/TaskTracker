...
- **`claude`** — карточки — это задачи самого Claude. В начале каждой сессии плагин говорит
  Claude расписывать любую работу больше чем в один шаг задачами и вести их статусы; каждая
  задача — карточка с пометкой `TODO`, которая движется вместе с работой Claude.
...
Версия остаётся **0.0.1** — почему и как изменение доходит до установленного плагина,
