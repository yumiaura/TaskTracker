...
Панель откроется на http://127.0.0.1:8787. Откуда берутся карточки — из задач Claude или
из каждого твоего запроса — задаётся в `.env`; см. [`.env.example`](../.env.example).
